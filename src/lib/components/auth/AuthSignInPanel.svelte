<script lang="ts">
  ...
  type AuthForm = { sent?: boolean; email?: string; error?: string } | null | undefined;
  ...
  let {
    ...
    emailFormAction?: string;
    emailSuccess?: Snippet;
    loggedIn?: Snippet;
  } = $props();
  ...
  <div class="login-card">
    ...
    {:else}
      <div class="auth-options">
        ...
        {#if showEmail}
          <form method="POST" action={emailFormAction} use:enhance>
            {#if form?.error}
        ...
        {:else}
          <button type="button" class="email-toggle" onclick={() => (showEmail = true)}>
            Continue with email
          </button>
        {/if}
      </div>
